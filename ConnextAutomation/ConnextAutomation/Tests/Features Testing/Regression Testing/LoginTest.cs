...
namespace Connext.UITest.Tests.Features_Testing.Regression_Testing
{
    ...
    internal class LoginTest : BaseTestCase
    {
        ...
        public void TC001_login_with_invalid_valid_account()
        {
            ...
            string fullname = LoginPage.fullname;
            ...
            try
            {
                ...
                verifyPoint = LoginAction.Instance.IsLeadMenuShown(10); // IsLeadMenuShown(10); IsKPIDashboardMenuShown
                verifyPoints.Add(summaryTC = "Verify 'Lead' page is shown after login successfully", verifyPoint);
                ExtReportResult(verifyPoint, summaryTC);
