...
namespace Connext.FunctionalTest.PredefinedScenarios
{
    internal class LeadTest : BaseFunctionTest
    {
        ...
        model = "crm.lead";
        internal static int id = 82; // old: 205
        internal static int? recordId;
        internal static string leadName = "QA Test API Lead";
        internal static string phone = "02119899991";
        internal static int loaiNguonId = 58; // 58 = Offline / Giới thiệu / CBNV - BVĐK HN; 36 = Offline / Giới thiệu / C2C ; 16 = Offline / Tự đến
        internal static int cbnv = 130; // 130 = (bthuy)
        internal static int stage_id = 24; // old: 73
        internal static int uid = 98; // old: 51
        #endregion
        ...
        public void ST001_Post_Create_Lead()
        {
            ...
            string body = @"{
                          ...
                          " + "\n" +                  "\"name\"" + ": " + "\"" + leadName + "\"" + ","
                            + "\n" +                  "\"contract_code\"" + ": " + "false" + ","
                            + "\n" +                  "\"expected_revenue\"" + ": " + 0 + ","
                            + "\n" +                  "\"automated_probability\"" + ": " + 14.39 + ","
                            + "\n" +                  "\"probability\"" + ": " + 0 + ","
                            + "\n" +                  "\"partner_id\"" + ": " + "false" + ","
                            + "\n" +                  "\"partner_name\"" + ": " + "false" + "," // for IVF
                            + "\n" +                  "\"contact_name\"" + ": " + "false" + ","
                            + "\n" +                  "\"birthday\"" + ": " + "false" + ","
                            + "\n" +                  "\"year_of_birth\"" + ": " + 0 + ","
                            + "\n" +                  "\"phone\"" + ": " + "\"" + phone + "\"" + ","
                            ...
                            + "\n" +                  "\"function\"" + ": " + "false" + ","
                            + "\n" +                  "\"mobile\"" + ": " + "false" + ","
                            //+ "\n" +                  "\"corporate_sale\"" + ": " + "false" + "," // Invalid field 'corporate_sale' on model 'crm.lead'
                            + "\n" +                  "\"index_beta_hcg_ids\"" + ": " + "[]" + ","
            ...
            Assert.That((int?)responseJs["result"], Is.GreaterThanOrEqualTo(20000));
            #endregion
        }
